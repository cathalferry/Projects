...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <img src="logo.jpg" style="width: 1046px; height: 139px" /><br />
        <h1>Search for a Student or Lecturer record</h1>
    <br />
    <p>
        Please select which database you would like to search from the drop down box, you can search for student or lecturer records, you can search by first name, last name or by ID Number.
    </p>
    <p>
        &nbsp;</p>
    ...
    <p>
        ...
        &nbsp;<br />
            ...
            <asp:ListView ID="ListAllLecturers" runat="server" Visible="false" OnSelectedIndexChanged="lstAllLecturers_SelectedIndexChanged">
                <LayoutTemplate>
                        ...
                        <tr id="Tr1" runat="server">
                            <td id="Td1" runat="server">
                                <table id="itemPlaceholderContainer" runat="server" border="1">
                                    <tr id="Tr2" runat="server">
                                        <th id="Th1" runat="server" border="1"></th>
                                        <th id="Th2" runat="server">Lecturer_ID</th>
                                        <th id="Th3" runat="server">First_Name</th>
                                        <th id="Th4" runat="server">Surname</th>
                                        <th id="Th5" runat="server">Address</th>
                                        <th id="Th6" runat="server">Background</th>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblLecturerID" runat="server" Text='<%# Eval("Lecturer ID") %>' />
                        </td>
                        <td>
                            <asp:Label ID="FirstNamelbl" runat="server" Text='<%# Eval("First Name") %>' />
                        </td>
                        <td>
                            <asp:Label ID="Surnamelbl" runat="server" Text='<%# Eval("Surname") %>' />
                        </td>
                        <td>
                            <asp:Label ID="Address2Label" runat="server" Text='<%# Eval("Address") %>' />
                        </td>
                         <td>
