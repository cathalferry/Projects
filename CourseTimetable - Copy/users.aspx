<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="users.aspx.cs" Inherits="CourseTimetable.users" %>
...
<body>
    ...
    <div>
    <div class="jumbotron">
        <h1>View Registered Users on Coursetimetable.ie</h1>
        ...
        <div class="col-md-4">
            ...
            <p>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:ct_ds_courses %>" DeleteCommand="DELETE FROM [User_Table] WHERE [UserID] = @original_UserID AND [Password] = @original_Password AND (([UserType] = @original_UserType) OR ([UserType] IS NULL AND @original_UserType IS NULL))" InsertCommand="INSERT INTO [User_Table] ([Password], [UserID], [UserType]) VALUES (@Password, @UserID, @UserType)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT [Password], [UserID], [UserType] FROM [User_Table]" UpdateCommand="UPDATE [User_Table] SET [Password] = @Password, [UserType] = @UserType WHERE [UserID] = @original_UserID AND [Password] = @original_Password AND (([UserType] = @original_UserType) OR ([UserType] IS NULL AND @original_UserType IS NULL))">
                    <DeleteParameters>
